<PropsTable :data="[
  ...
  {
    'name': 'dir',
    'description': '<p>时间字段的读取方向（适用时）。<br>如果省略，则从<code>ConfigProvider</code>全局继承或采用LTR（从左到右）读取模式。</p>\n',
    'type': '\'ltr\' | \'rtl\'',
    'required': false
  },
  {
    'name': 'disabled',
    'description': '<p>是否禁用时间字段</p>\n',
    'type': 'boolean',
    'required': false,
    'default': 'false'
  },
  {
    'name': 'granularity',
    'description': '<p>用于格式化时间的颗粒度。如果提供了时间，则默认为分钟，否则默认为分钟。该字段将为日期的每个部分截至指定颗粒度的片段并渲染</p>\n',
  ...
  {
    'name': 'modelValue',
    'description': '<p>字段的受控选中状态。可以绑定为<code>v-model</code>。</p>\n',
    'type': 'TimeValue | null',
    'required': false
  },
  {
  ...
  {
    'name': 'placeholder',
    'description': '<p>占位日期，用于确定未选择时间时显示的时间。这会在用户导航字段时更新</p>\n',
    'type': 'TimeValue',
    'required': false
  },
  {
    'name': 'readonly',
    'description': '<p>时间字段是否只读</p>\n',
    'type': 'boolean',
    'required': false,
    'default': 'false'
  },
...
<SlotsTable :data="[
  {
    'name': 'modelValue',
    'description': '<p>字段的当前时间</p>\n',
    'type': 'TimeValue | undefined'
  },
  {
    'name': 'segments',
    'description': '<p>时间字段段内容</p>\n',

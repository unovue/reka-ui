<PropsTable :data="[
  ...
  {
    'name': 'bodyLock',
    'description': '<p>document.body 将被锁定，滚动将被禁用。</p>\n',
    'type': 'boolean',
    'required': false
  },
  {
  ...
  {
    'name': 'position',
    'description': '<p>使用</p>\n<p><code>item-aligned</code>（默认）的定位模式-通过相对于活动项目定位内容，其行为类似于原生MacOS菜单。<br>\n<code>popper</code>-以与我们的其他 primitives 相同的方式定位内容，例如<code>Popover</code>或<code>DropdownMenu</code>。</p>\n',

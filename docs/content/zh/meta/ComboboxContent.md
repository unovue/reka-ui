<PropsTable :data="[
  ...
  {
    'name': 'position',
    'description': '<p>要使用的定位模式，默认是<code>inline</code>，您可以使用 CSS 控制位置。<code>popper</code>定位内容的方式与我们的其他 primitives 相同，例如<code>Popover</code>或<code>DropdownMenu</code>。</p>\n',
    'type': '\'inline\' | \'popper\'',
    'required': false
  },
  {

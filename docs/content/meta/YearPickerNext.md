...
| `nextPage` | The function to be used for the next page. Overwrites the nextPage function set on the YearPickerRoot. | `((placeholder: TemporalDate) => TemporalDate)` | No | - |

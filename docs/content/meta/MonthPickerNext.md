...
| `nextPage` | The function to be used for the next page. Overwrites the nextPage function set on the MonthPickerRoot. | `((placeholder: TemporalDate) => TemporalDate)` | No | - |

...
| `prevPage` | The function to be used for the prev page. Overwrites the prevPage function set on the MonthPickerRoot. | `((placeholder: TemporalDate) => TemporalDate)` | No | - |

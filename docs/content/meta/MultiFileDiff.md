...
<PropsTable :data="[
  ...
  {
    'name': 'newFile',
    'description': '<p>Next file contents used to compute the diff.</p>\n',
    'type': 'FileContents',
    'required': true
  },
  {
    'name': 'oldFile',
    'description': '<p>Previous file contents used to compute the diff.</p>\n',
    'type': 'FileContents',
    'required': true
  },
  {
...
| `newFile` | Next file contents used to compute the diff. | `FileContents` | Yes | - |
| `oldFile` | Previous file contents used to compute the diff. | `FileContents` | Yes | - |

...
| `nextPage` | The function to be used for the next page. Overwrites the nextPage function set on the RangeCalendarRoot. | `((placeholder: TemporalDate) => TemporalDate)` | No | - |

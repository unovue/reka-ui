...
| `defaultValue` | The default value for the month picker | `TemporalDate` | No | - |
...
| `modelValue` | The controlled selected month value of the month picker. Can be bound as v-model. | `TemporalDate \| TemporalDate[]` | No | - |
| `multiple` | Whether multiple months can be selected | `boolean` | No | `false` |
| `nextPage` | A function that returns the next page of the month picker. Receives the current placeholder as an argument. | `((placeholder: TemporalDate) => TemporalDate)` | No | - |
...
| `prevPage` | A function that returns the previous page of the month picker. Receives the current placeholder as an argument. | `((placeholder: TemporalDate) => TemporalDate)` | No | - |

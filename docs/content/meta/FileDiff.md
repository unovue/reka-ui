...
<PropsTable :data="[
  ...
  {
    'name': 'fileDiff',
    'description': '<p>Parsed Pierre file diff metadata, such as the result of <code>parseDiffFromFile</code> or <code>parsePatchFiles</code>.</p>\n',
...
| `fileDiff` | Parsed Pierre file diff metadata, such as the result of parseDiffFromFile or parsePatchFiles. | `FileDiffMetadata` | Yes | - |

...
defineProps<{ portalTarget: HTMLDivElement, modal: boolean }>()
...
<template>
  <div class="flex flex-col items-center justify-center">
    ...
    <span>{{ modal ? 'Modal' : 'Non-Modal' }}</span>
    <DropdownMenuRoot
      v-model:open="toggleState"
      :modal="modal"
    >
      <DropdownMenuTrigger
        :data-testid="modal ? 'dropdown-trigger-modal' : 'dropdown-trigger-nonmodal'"
      ...
      <DropdownMenuPortal :to="portalTarget">
        <DropdownMenuContent
          :data-testid="modal ? 'dropdown-content-modal' : 'dropdown-content-nonmodal'"
          :class="content"
          :side-offset="4"
        >
          <DropdownMenuItem
          ...
          <DropdownMenuSub>
            <DropdownMenuSubTrigger
              value="more tools"
              :class="item"
              data-testid="more-tools-subtrigger"
            >
              More Tools
              <div
            ...
            <DropdownMenuPortal :to="portalTarget">
              <DropdownMenuSubContent
                data-testid="dropdown-subcontent"
                :class="subContent"
                :side-offset="2"
                :align-offset="-4"
              >

  ...
  <div class="flex flex-col items-center justify-center">
    ...
    >
      <PopoverTrigger
        ...
        :data-testid="modal ? 'popover-trigger-modal' : 'popover-trigger-nonmodal'"
      ...
      <PopoverPortal :to="portalTarget">
        <PopoverContent
          :data-testid="modal ? 'popover-content-modal' : 'popover-content-nonmodal'"
          side="bottom"
          :side-offset="5"
          ...
          <div class="flex flex-col gap-2.5">
            ...
            <fieldset class="flex gap-5 items-center">
              ...
              <input
                ...
                defaultValue="100%"
                data-testid="popover-first-input"
              >
            </fieldset>
            <fieldset class="flex gap-5 items-center">
              <label

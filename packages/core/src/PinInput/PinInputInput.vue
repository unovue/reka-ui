...
function handleMultipleCharacter(values: string) {
  const tempModelValue = [...context.currentModelValue.value] as PinInputValue<typeof context.type.value, typeof context.modelValue.value[number]>
...
function removeTrailingEmptyStrings(input: PinInputValue<typeof context.type.value, typeof context.modelValue.value[number]>) {

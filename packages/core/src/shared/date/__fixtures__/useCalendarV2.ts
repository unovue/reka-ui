/*
 * Frozen copy of the v2 day-view `useCalendar` composable (Calendar/useCalendar.ts as of
 * reka-ui 2.10), kept ONLY as the oracle for the `useCalendarGrid` parity tests.

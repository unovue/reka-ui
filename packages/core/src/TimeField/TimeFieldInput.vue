...
const {
  ...
  yearStep: rootContext.yearStep,
  monthStep: rootContext.monthStep,
  dayStep: rootContext.dayStep,
  hourStep: rootContext.hourStep,
  minuteStep: rootContext.minuteStep,
  secondStep: rootContext.secondStep,

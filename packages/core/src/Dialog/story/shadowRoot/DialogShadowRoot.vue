...
import ComboboxMultipleShadowRoot from './ComboboxMultipleShadowRoot.vue'
import DropdownShadowRoot from './DropdownShadowRoot.vue'
import PopoverShadowRoot from './PopoverShadowRoot.vue'
    ...
    <DialogPortal :to="portalTarget">
      ...
      <Transition name="fade">
        ...
        >
          ...
          <div class="flex">
            <ComboboxMultipleShadowRoot :portal-target="portalTarget" />
            <DropdownShadowRoot :portal-target="portalTarget" />
            <PopoverShadowRoot :portal-target="portalTarget" />
          </div>

...
import { resolveDOMTarget, useEmitAsProps, useForwardExpose } from '@/shared'
...
const resolveContainer = () => resolveDOMTarget(rootContext.container.value)
